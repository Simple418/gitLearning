...
public class Login extends AppCompatActivity {
    ...
    private Button loginButton,btnLinkToRegisterScreen;
    ...
    private void init(){
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //spPsw 为 根据从SharedPreferences中用户名读取密码
                // 定义方法 readPsw为了读取用户名，得到密码
                String spPsw=readPsw(email);
                // TextUtils.isEmpty
                if(TextUtils.isEmpty(email)){
                    Toast.makeText(Login.this, "Please input email", Toast.LENGTH_SHORT).show();
                    return;
                   ...
                   data.setClass(Login.this, MainActivity.class);
                   startActivity(data);
                    //startActivityForResult(intent, 1);
                    //销毁登录界面
                    Login.this.finish();
                    ...
                    Toast.makeText(Login.this, "the user is not matching to its password", Toast.LENGTH_SHORT).show();
                    return;
                }else{
                    Toast.makeText(Login.this, "the user not exit", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    /*public void btnLogin(View view) {
        ...
        if (!email.isEmpty() && !password.isEmpty()) {
            ...
            Toast.makeText(getApplicationContext(),
                    R.string.enter_credentials, Toast.LENGTH_LONG).show();
        }
    }*/
